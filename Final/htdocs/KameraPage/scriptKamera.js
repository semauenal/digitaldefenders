function freischaltungKamera() {
  ...
  //Document = Objekt --> query Selector ist eine Methode des document und ermöglicht es, ein Element aus HTML zu finden 
    ...
    if (macAdresse === "MUT-FUCHS-HERZ-543210-SATURN-BACHELOR") { //MUT-FUCHS-HERZ-543210-SATURN-BACHELOR
    ...
    successBox = document.createElement("div");
      ...
      successText.textContent = "Ihre Eingabe war richtig. Leider liegt ein Problem bei der Verbindung vor. Bitte beheben Sie dieses, damit Sie Zugriff auf die Kamera haben. Hinweis: narK";
      ...
      networkErrorFixedButton.addEventListener("click", function() {
        window.location.href = "/VideoPage/indexVideo.html"; 
      });
